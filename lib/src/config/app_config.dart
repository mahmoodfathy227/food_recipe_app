...
class AppConfig {
  ...
  static Future<void> init() async {
    debugPrint('[AppConfig] init; default API $kDefaultTheMealDb (override via .env)');
    dio = Dio(
      BaseOptions(
        baseUrl: _getBaseUrl(),
  ...
  static const String kDefaultTheMealDb =
      'https://www.themealdb.com/api/json/v1/1/';

  static String _getBaseUrl() {
    return dotenv.get('API_BASE_URL', fallback: kDefaultTheMealDb);
  }
}
